                ...
                <tr>
                  ...
                  <td class="align-middle">
                            ...
                            <form action="teacher-delete/{{ $item->id }}" method="POST">
                              ...
                              <div class="modal-body">
                                <div class="py-3 text-center">
                                  ...
                                  <h7 class="text-gradient text-danger">Apakah yakin kamu ingin menghapus Akun <br><b>{{
                                      $item->full_name }}</b> !</h7>
                    ...
                    {{-- <a class="btn btn-sm bg-gradient-info text-white px-3 mb-0" href="javascript:;"
                      data-toggle="tooltip" data-original-title="Edit user"><i class="fas fa-pencil-alt me-2"
